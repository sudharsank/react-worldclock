...
var Clock_module_scss_1 = require("./Clock.module.scss");
...
var Clock = (function (_super) {
    ...
    function Clock(props) {
        ...
        _this.state = {
            date: _this.getDateTimeWithOffset()
        };
        return _this;
    }
    Clock.prototype.componentDidMount = function () {
        var _this = this;
        this._timerID = setInterval(function () { return _this.tick(); }, 1000);
    };
    Clock.prototype.componentWillUnmount = function () {
        clearInterval(this._timerID);
    };
    Clock.prototype.render = function () {
        var hoursDegrees = this.state.date.getHours() * 30 + this.state.date.getMinutes() / 2;
        var minutesDegrees = this.state.date.getMinutes() * 6 + this.state.date.getSeconds() / 10;
        var secondsDegrees = this.state.date.getSeconds() * 6;
        var divStyleHours = {
